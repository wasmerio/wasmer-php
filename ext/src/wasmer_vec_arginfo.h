...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Wasm_Vec_ExportType_count, 0, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Wasm_Vec_ExportType_offsetExists, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, offset, IS_MIXED, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Wasm_Vec_ExportType_offsetGet, 0, 1, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, offset, IS_MIXED, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Wasm_Vec_ExportType_offsetSet, 0, 2, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, offset, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, value, IS_MIXED, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Wasm_Vec_ExportType_offsetUnset, 0, 1, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, offset, IS_MIXED, 0)
ZEND_END_ARG_INFO()
...
#define arginfo_class_Wasm_Vec_ExternType_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_ExternType_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_ExternType_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_ExternType_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_ExternType_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_FuncType_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_FuncType_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_FuncType_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_FuncType_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_FuncType_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_GlobalType_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_GlobalType_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_GlobalType_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_GlobalType_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_GlobalType_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_ImportType_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_ImportType_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_ImportType_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_ImportType_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_ImportType_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_MemoryType_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_MemoryType_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_MemoryType_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_MemoryType_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_MemoryType_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_TableType_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_TableType_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_TableType_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_TableType_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_TableType_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_ValType_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_ValType_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_ValType_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_ValType_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_ValType_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_Extern_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_Extern_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_Extern_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_Extern_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_Extern_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_Frame_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_Frame_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_Frame_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_Frame_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet

#define arginfo_class_Wasm_Vec_Frame_offsetUnset arginfo_class_Wasm_Vec_ExportType_offsetUnset
...
#define arginfo_class_Wasm_Vec_Val_count arginfo_class_Wasm_Vec_ExportType_count

#define arginfo_class_Wasm_Vec_Val_offsetExists arginfo_class_Wasm_Vec_ExportType_offsetExists

#define arginfo_class_Wasm_Vec_Val_offsetGet arginfo_class_Wasm_Vec_ExportType_offsetGet

#define arginfo_class_Wasm_Vec_Val_offsetSet arginfo_class_Wasm_Vec_ExportType_offsetSet
