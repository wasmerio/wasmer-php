...
PHP_MINIT_FUNCTION(wasm)
{
    ...
    zend_class_implements(wasm_typed_array_int8_class_entry TSRMLS_CC, 1, zend_ce_arrayaccess);
    ...
    zend_class_implements(wasm_typed_array_uint8_class_entry TSRMLS_CC, 1, zend_ce_arrayaccess);
